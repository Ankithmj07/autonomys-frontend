...
const SuiteCardComponent: React.FC<SuiteCardProps> = ({
  ...
  return (
    <div
      className={`flex flex-col lg:flex-row px-4 lg:px-10 items-center justify-between w-full gap-8 lg:gap-20`}
    >
      {/* Left Text */}
      <div className="flex-1">
        <h3 className="text-white text-[26px] mb-3">{topTitle}</h3>
        <h2
          className="text-[40px] lg:text-[54px] leading-tight"
          style={{
      ...
      <div className="flex-0.9 flex justify-center">
        ...
        {bgImage && (
          ...
          <img src={image} alt={title} className="relative z-10 w-full lg:w-[366px] object-contain" />
