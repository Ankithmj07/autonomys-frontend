...
const ProtocolSection: React.FC = () => {
  return (
    <div className='bg-[#d1d8eb] flex justify-center py-10 px-4 lg:px-0 lg:py-30 lg:pb-40'>
        <section className="relative lg:w-[80%] overflow-hidden rounded-[2rem] py-10 lg:py-30"
        style={{
        ...
        >
          ...
          <img
            src={GreenRingImage}
            alt="Background Ring"
            className="absolute right-[-800px] top-159 lg:right-[-640px] lg:top-90 w-[700px]  scale-[8.5] lg:scale-[4.5]  z-0 pointer-events-none"
          />

          <div className="relative z-10 flex flex-col lg:flex-row items-center">
            {/* Left Content */}
            <div className="max-w-xl text-left px-6 lg:py-8 lg:px-15">
              <h2 className="text-4xl lg:text-[54px] font-serif text-[#2d2d46] mb-4">Subspace Protocol</h2>
