...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed sticky z-1000 w-full py-3 flex justify-between px-4 space-x-28 lg:px-35 lg:space-x-38 items-center mt-5">
      {/* Logo */}
      ...
      {/* Desktop Menu */}
      <div className="hidden md:flex space-x-8 px-5 text-white font-medium bg-[#292a4126] backdrop-blur-sm rounded-[14px] h-[52px]">
      ...
      {/* Mobile Menu Button */}
      <button
        className="md:hidden bg-white p-2 w-[72px] flex justify-center items-center h-[52px] rounded-xl shadow"
