...
const Navbar: React.FC = () => {
  ...
  return (
    ...
    <nav className="fixed sticky z-1000 w-full py-3 flex justify-between px-4 space-x-28 lg:px-24  xl:px-35 md:space-x-138 lg:space-x-30 xl:space-x-38 items-center mt-5">
      {/* Logo */}
      ...
      <div className="hidden lg:flex space-x-8  px-5 text-white font-medium bg-[#292a4126] backdrop-blur-sm rounded-[14px] h-[52px]">
        <ul className="hidden lg:flex space-x-10  2xl:space-x-17 text-white font-medium">
          {menuItems.map((item) => (
